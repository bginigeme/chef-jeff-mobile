        ...
        <ScrollView style={styles.content} showsVerticalScrollIndicator={false}>
          ...
          {onRate && (
            <View style={styles.rateRow}>
              <TouchableOpacity
                style={[styles.rateButton, currentRating === 'like' && styles.rateLikeActive]}
                onPress={() => onRate(recipe, 'like')}
              >
                <Text style={styles.rateText}>👍 Like</Text>
              </TouchableOpacity>
              <TouchableOpacity
                style={[styles.rateButton, currentRating === 'dislike' && styles.rateDislikeActive]}
                onPress={() => onRate(recipe, 'dislike')}
              >
...
const styles = StyleSheet.create({
  ...
  rateLikeActive: { backgroundColor: '#DCFCE7' },
  rateDislikeActive: { backgroundColor: '#FEE2E2' },
  rateText: { fontSize: 14, fontWeight: '600', color: '#111827' },
}) 
